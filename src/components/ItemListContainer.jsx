...
// //                         if (searchTerm) {
// //                             const normalizedSearch = normalizarTexto(searchTerm);
// //                             const keywords = normalizedSearch.split(/\s+/).filter(Boolean); // <-- NUEVO: Divide en palabras
...
// //                                 `;
// //                                 return keywords.every(keyword => searchText.includes(keyword)); // <-- NUEVO: Verifica cada palabra
// //                             });
// //                         }
// //                         else if (oferta) {
// //                             filtrados = filtrados.filter(item => item.descuento > 0);
...
// import { useEffect, useState, useCallback, useMemo } from "react"; // Agregué useMemo
// import ItemList from "./ItemList";
// import { useParams, Link, useLocation, useSearchParams } from "react-router-dom";
// import { getFirestore, collection, getDocs } from "firebase/firestore";
// import Loading from "./Loading";
...
//     // Efecto para cargar TODOS los productos una única vez
//     useEffect(() => {
...
//     // Usa useMemo para aplicar los filtros y el ordenamiento de forma eficiente
//     const filteredAndSortedItems = useMemo(() => {
//         let filtrados = [...allProducts];

//         // Filtros principales (categoría, búsqueda, oferta, etc.)
//         if (searchTerm) {
//             const normalizedSearch = normalizarTexto(searchTerm);
//             const keywords = normalizedSearch.split(/\s+/).filter(Boolean);
//             filtrados = filtrados.filter(item => {
...
//             }
//         });
//     }, [allProducts, id, top, oferta, searchTerm, location.pathname, priceRange, sortBy, normalizarTexto]);
